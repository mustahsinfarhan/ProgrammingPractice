...
Then to launch the program, run the following in the terminal:
./main

To clean the build, run the following in the terminals:
make clean

All combined - To clean, rebuild and then run:
